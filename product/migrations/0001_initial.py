# Generated by Django 3.1.6 on 2021-02-19 15:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='prodcut/', verbose_name='Image')),
                ...
                ('like', models.ManyToManyField(blank=True, to='product.Customer')),
            ],
        ),
        migrations.CreateModel(
